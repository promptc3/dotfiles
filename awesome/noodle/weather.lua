...
local key = "4a116b32bf64d39f1f40c43998bf6a39"
local city_id = "1270396"
local units = "metric"
local symbol = "°C"
...
local weather_details_script = [[
  ...
  weather=$(curl -x "http://10.31.0.1:8080" -sf "http://api.openweathermap.org/data/2.5/weather?APPID=$KEY&id=$CITY&units=$UNITS")
