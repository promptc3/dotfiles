...
keys.globalkeys = gears.table.join(
    ...
    -- Logout, Shutdown, Reboot, Suspend, Lock
    ...
    awful.key({ superkey }, "F5", function()
        start_screen_show()
              ...
              {description = "start screen", group = "notifications"}),
    -- Volume Control
    ...
    -- Media keys
    awful.key({ superkey }, "F11", function() awful.spawn.with_shell("mpc next") end,
    {description = "next song", group = "media"}),
    awful.key({ superkey }, "F9", function() awful.spawn.with_shell("mpc prev") end,
    {description = "previous song", group = "media"}),
    awful.key({ superkey }, "F10", function() awful.spawn.with_shell("mpc toggle") end,
    ...
    awful.key({ superkey }, "x", function() awful.spawn.with_shell("i3lock") end,
    ...
    -- Open new vim
    awful.key({ superkey }, "e", function() awful.spawn.with_shell("vim") end,
